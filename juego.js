...
class Juego {
  constructor() {
    // En este caso no recibe ningun parámetro pero si métodos/acciones
  ...
  inicializar() {
    ...
    this.nivel = 1;
    this.colores = {
      // Acá ponemos a los BOTONES con el metodo COLORES para tenerlos más fácil
      // celeste: celeste
  ...
  agregarEventosClick() {
    // Le agrega a los botones (que los llamamos this.colores) un evento click
...
function empezarJuego() {
  // Esta función de empezar juego, esta declarada en el BOTON de HTML
